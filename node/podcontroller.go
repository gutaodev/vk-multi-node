...
import (
	...
	"github.com/gutaodev/vk-multi-node/internal/manager"
	"github.com/gutaodev/vk-multi-node/internal/queue"
...
// github.com/gutaodev/vk-multi-node/errdefs package in order for the
...
func (pc *PodController) syncPodInProvider(ctx context.Context, pod *corev1.Pod, key string) (retErr error) {
	...
	// more context is here: https://github.com/gutaodev/vk-multi-node/pull/760
