...
// todo
func newMultiLeaseControllerWithRenewInterval(
	clock clock.Clock,
	client coordclientset.LeaseInterface,
	leaseDurationSeconds int32,
	renewInterval time.Duration,
	nodeController *MultiNodeController) (*multiLeaseController, error) {
...
type multiLeaseController struct {
	leaseClient          coordclientset.LeaseInterface
	leaseDurationSeconds int32
	renewInterval        time.Duration
	clock                clock.Clock
	nodeController       *MultiNodeController
	// latestLease is the latest node lease which Kubelet updated or created
	latestLease *coordinationv1.Lease
}

// Run runs the controller
func (c *multiLeaseController) Run(ctx context.Context) {
	c.sync(ctx)
	wait.UntilWithContext(ctx, c.sync, c.renewInterval)
}

func (c *multiLeaseController) sync(ctx context.Context) {
...
// false otherwise.
func (c *multiLeaseController) backoffEnsureLease(ctx context.Context, node *corev1.Node) (*coordinationv1.Lease, bool) {
...
func (c *multiLeaseController) ensureLease(ctx context.Context, node *corev1.Node) (*coordinationv1.Lease, bool, error) {
...
func (c *multiLeaseController) retryUpdateLease(ctx context.Context, node *corev1.Node, base *coordinationv1.Lease) error {
...
func (c *multiLeaseController) newLease(ctx context.Context, node *corev1.Node, base *coordinationv1.Lease) *coordinationv1.Lease {
